...
namespace Ordering.Infrastructure.Data.Extensions
{
    internal class InitialData
    {
        ...
        new List<Customer>
        {
        Customer.Create(CustomerId.Of(new Guid("58c49479-ec65-4de2-86e7-033c546291aa")), "Blgikey", "Blgikey@gmail.com"),
        Customer.Create(CustomerId.Of(new Guid("189dc8dc-990f-48e0-a37b-e6f2b60b9d7d")), "Mohamed", "Mohamed@gmail.com")
        };
        ...
        public static IEnumerable<Order> OrdersWithItems
        {
            get
            {
                var address1 = Address.Of("Mohamed", "Blgikey", "Blgikey@gmail.com", "Maadi No:4", "Egypt", "Maadi", "68020");
                var address2 = Address.Of("Blgikey", "Ahmed", "Ahmed@gmail.com", "15 Maadi No:1", "Egypt", "Cairo", "68200");

                var payment1 = Payment.Of("Mohamed", "5555555555554444", "12/28", "355", 1);
                var payment2 = Payment.Of("Blgikey", "8885555555554444", "06/30", "222", 2);
